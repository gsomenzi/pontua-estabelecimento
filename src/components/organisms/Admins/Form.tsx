...
export default function Form(props: Props) {
    ...
    useEffect(() => {
        if (admin) {
            ...
            // FUNCAO
            if (admin.funcao) {
                setFieldValue('funcoes_id', admin.funcao.id);
            }
        }
    }, [admin]);
    // SUBMIT
    ...
    return (
        <BootstrapForm onSubmit={handleSubmit}>
            ...
            <FormGroup>
                ...
                <Input
                    value={values.funcoes_id}
                    onBlur={handleBlur('funcoes_id')}
                    onChange={handleChange('funcoes_id')}
                    type="select"
                    name="funcao"
                    id="selectFuncao"
                    invalid={!!(formErrors.funcoes_id && touched.funcoes_id)}
                >
                ...
                <FormFeedback>{formErrors.funcoes_id}</FormFeedback>
            </FormGroup>
            {/* ERROR */}
